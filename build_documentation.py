...
def build_technical_manual():
    ...
    add_body(doc, "The program is designed for Windows desktop use through a minimal Tkinter UI and for unattended execution through the same executable with command-line arguments and Windows Task Scheduler. The source remains a single Python program; the Windows workflow creates one combined entry point.")
